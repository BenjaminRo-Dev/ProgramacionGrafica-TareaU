...
namespace TareaU
{
    class Game : GameWindow
    {
        ...
        protected override void OnLoad()
        {
            ...
            objetoCargado = JsonLoader.Cargar("../../../datos/letraU.json");
            escenario.AgregarObjeto(objetoCargado);
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            // objetoCargado.Rotacion = new Vector3(45, 45, 90);
            // objetoCargado.Actualizar();
            // escenario.Rotacion = new Vector3(45, 45, 90);
            // objetoCargado.Partes[0].Rotacion = new Vector3(180, 0, 0);
            // objetoCargado.Partes[0].Actualizar();
